...
df_all_ap_control = pd.read_csv("output/inputs/measure_control_ap_prescribing_rate_all.csv").dropna()
df_all_ad_control = pd.read_csv("output/inputs/measure_control_ad_prescribing_rate_all.csv").dropna()
df_region_ap_control = pd.read_csv("output/inputs/measure_control_ap_prescribing_rate_region.csv").dropna()
df_region_ad_control = pd.read_csv("output/inputs/measure_control_ad_prescribing_rate_region.csv").dropna()
df_age_ap_control = pd.read_csv("output/inputs/measure_control_ap_prescribing_rate_age.csv").dropna()
df_age_ad_control = pd.read_csv("output/inputs/measure_control_ad_prescribing_rate_age.csv").dropna()

df_all_ap_new_control = pd.read_csv("output/inputs/measure_control_ap_prescribing_new_all.csv").dropna()
df_all_ad_new_control = pd.read_csv("output/inputs/measure_control_ad_prescribing_new_all.csv").dropna()
df_region_ap_new_control = pd.read_csv("output/inputs/measure_control_ap_prescribing_new_region.csv").dropna()
df_region_ad_new_control = pd.read_csv("output/inputs/measure_control_ad_prescribing_new_region.csv").dropna()
df_age_ap_new_control = pd.read_csv("output/inputs/measure_control_ap_prescribing_new_age.csv").dropna()
df_age_ad_new_control = pd.read_csv("output/inputs/measure_control_ad_prescribing_new_age.csv").dropna()
