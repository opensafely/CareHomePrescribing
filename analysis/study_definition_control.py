...
measures = [
    ...
    # antipsychotic age
    Measure(
        id="control_ap_prescribing_rate_age",
        numerator="antipsychotics_prescribing",
        denominator="population",
    ...
    Measure(
        id="control_ap_prescribing_rate_region",
        numerator="antipsychotics_prescribing",
        denominator="population",
        group_by = ["region"],
        # small_number_suppression=True
    ...
    Measure(
        id="control_ap_prescribing_new_age",
        numerator="ap_new_initiation",
        denominator="population",
        group_by = ["ageband_narrow"],
        # small_number_suppression=True
    ...
    Measure(
        id="control_ap_prescribing_new_region",
        numerator="ap_new_initiation",
        denominator="population",
        group_by = ["region"],
        # small_number_suppression=True
    ...
    # antidepressent age
    Measure(
        id="control_ad_prescribing_rate_age",
        numerator="antidepressent_ssri",
        denominator="population",
        group_by = ["ageband_narrow"],
        # small_number_suppression=True
    ...
    Measure(
        id="control_ad_prescribing_rate_region",
        numerator="antidepressent_ssri",
        denominator="population",
        group_by = ["region"],
        # small_number_suppression=True
    ...
    Measure(
        id="control_ad_prescribing_new_age",
        numerator="ad_new_initiation",
        denominator="population",
        group_by = ["ageband_narrow"],
        # small_number_suppression=True
    ...
    Measure(
        id="control_ad_prescribing_new_region",
        numerator="ad_new_initiation",
        denominator="population",
        group_by = ["region"],
        # small_number_suppression=True
